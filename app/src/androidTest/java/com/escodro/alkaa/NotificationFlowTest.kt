...
internal class NotificationFlowTest : KoinTest {
    ...
    @Test
    fun test_taskUpdateReflectsInNotification() =
        runTest {
    ...
    @Test
    fun test_taskCompletedIsNotNotified() =
        runTest {
    ...
    @Test
    fun test_completeTaskViaNotification() =
        runTest {
            // Insert a task
            val id = 3333L
    ...
    @Test
    fun test_snoozeTaskViaNotification() =
        runTest {
            // Insert a task
            val id = 9999L
    ...
    private fun insertRepeatingTask(name: String) =
        runTest {
