...
internal class RescheduleFutureAlarmsTest {
    ...
    @Test
    fun test_if_future_alarms_are_rescheduled() =
        runTest {
            val futureCalendar =
    ...
    @Test
    fun test_if_completed_tasks_are_not_rescheduled() =
        runTest {
            val futureCalendar =
                dateTimeProvider.getCurrentInstant()
                    .plus(15.days).toLocalDateTime(TimeZone.currentSystemDefault())
    ...
    @Test
    fun test_if_uncompleted_tasks_on_the_past_are_ignored() =
        runTest {
            val pastCalendar =
                dateTimeProvider.getCurrentInstant()
    ...
    @Test
    fun test_if_missed_repeating_alarms_are_rescheduled() =
        runTest {
            val pastCalendar =
                dateTimeProvider.getCurrentInstant()
