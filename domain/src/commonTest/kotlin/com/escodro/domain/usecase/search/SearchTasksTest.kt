...
internal class SearchTasksTest {
    ...
    @Test
    fun test_if_search_returns_correct_tasks() =
        runTest {
            val query = "birthday"
    ...
    @Test
    fun test_if_return_list_is_empty_when_query_is_not_found() =
        runTest {
    ...
    @Test
    fun test_if_all_tasks_are_returned_when_empty_query_is_passed() =
        runTest {
