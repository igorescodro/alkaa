...
internal class CompleteTaskTest {
    ...
    @Test
    fun test_if_a_task_is_updated_as_completed() =
        runTest {
    ...
    @Test
    fun test_if_a_task_is_updated_as_completed_by_id() =
        runTest {
    ...
    @Test
    fun test_if_a_task_is_updated_as_uncompleted() =
        runTest {
            val task = Task(id = 18, title = "buy soy milk", completed = false)
            addTaskUseCase(task)
    ...
    @Test
    fun test_if_the_completed_status_is_inverted() =
        runTest {
    ...
    @Test
    fun test_if_the_notification_is_dismissed_when_the_task_is_completed() =
        runTest {
