...
internal class LoadCompletedTasksByPeriodTest {
    ...
    @Test
    fun test_if_completed_tasks_are_returned_in_group() =
        runTest {
    ...
    @Test
    fun test_if_only_completed_tasks_are_returned() =
        runTest {
            val category1 = Category(1, "Category A", "#FFFFFF")
            val category2 = Category(2, "Category B", "#CCCCCC")
    ...
    @Test
    fun test_if_completed_tasks_without_category_are_considered() =
        runTest {
            val instant = Clock.System.now()
