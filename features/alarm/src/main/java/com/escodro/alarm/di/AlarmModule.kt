...
import com.escodro.alarm.interactor.AlarmPermissionInteractorImpl
...
val alarmModule = module {
    ...
    factory { PermissionNotification(androidContext(), get()) }

    factory { TaskMapper() }

    factory<AlarmInteractor> { AlarmInteractorImpl(get()) }
    factory<NotificationInteractor> { NotificationInteractorImpl(get(), get()) }
    factory<AlarmPermissionInteractor> { AlarmPermissionInteractorImpl(get()) }
