...
internal class TaskItemTest {
    ...
    fun test_dueDateIsShown() {
        ...
        composeTestRule.onNodeWithText(text = hour, useUnmergedTree = true, substring = true)
            .assertExists()
        composeTestRule.onNodeWithText(text = minute, useUnmergedTree = true, substring = true)
            .assertExists()
    }
