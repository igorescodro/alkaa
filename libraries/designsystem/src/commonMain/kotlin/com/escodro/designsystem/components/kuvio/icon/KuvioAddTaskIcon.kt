...
@Composable
private fun KuvioAddTaskIconLightPreview() {
    AlkaaThemePreview {
        KuvioAddTaskIcon(modifier = Modifier.size(48.dp))
    }
}

@Preview(showBackground = true, backgroundColor = 0xFF0F1B2D)
@Composable
private fun KuvioAddTaskIconDarkPreview() {
