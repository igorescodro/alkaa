...
@Composable
private fun KuvioRemindersIconLightPreview() {
    AlkaaThemePreview {
        KuvioRemindersIcon(modifier = Modifier.size(48.dp))
    }
}

@Preview(showBackground = true, backgroundColor = 0xFF0F1B2D)
@Composable
private fun KuvioRemindersIconDarkPreview() {
