...
@Composable
private fun KuvioHeadlineSmallTextLightPreview() {
    AlkaaThemePreview(isDarkTheme = false) {
        KuvioHeadlineSmallText(text = "Headline Small")
    }
}

@Preview(showBackground = true, backgroundColor = 0xFF0F1B2D)
@Composable
private fun KuvioHeadlineSmallTextDarkPreview() {
